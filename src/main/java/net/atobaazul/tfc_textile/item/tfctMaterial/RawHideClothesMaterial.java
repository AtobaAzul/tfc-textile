...
public class RawHideClothesMaterial implements ArmorMaterial, TemperatureAlteringMaterial {
    ...
    public TempModifier getTempModifier(ItemStack stack) {
        return new TempModifier(ForgeRegistries.ITEMS.getKey(stack.getItem()).toString(), 2f, -0.10f);
    }
}
