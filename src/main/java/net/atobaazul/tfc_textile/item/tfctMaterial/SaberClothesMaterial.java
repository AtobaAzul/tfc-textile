...
public class SaberClothesMaterial implements ArmorMaterial, TemperatureAlteringMaterial {

    public static final SaberClothesMaterial MATERIAL = new SaberClothesMaterial();
    ...
    public @NotNull Ingredient getRepairIngredient() {
        return Ingredient.of(new ItemStack(TFCTextileItems.SABER_FUR.get(), 1));
    }

    @Override
    public @NotNull String getName() {
        return "tfc_textile:saber_fur";
    }
