...
public class PantherClothesMaterial implements ArmorMaterial, TemperatureAlteringMaterial {
    ...
    public @NotNull Ingredient getRepairIngredient() {
        return Ingredient.of(new ItemStack(TFCTextileItems.PANTHER_FUR.get(), 1));
    }

    @Override
    public @NotNull String getName() {
        return "tfc_textile:panther_fur";
    }
