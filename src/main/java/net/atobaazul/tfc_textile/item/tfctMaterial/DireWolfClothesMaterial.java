...
public class DireWolfClothesMaterial implements ArmorMaterial, TemperatureAlteringMaterial {
    ...
    public @NotNull Ingredient getRepairIngredient() {
        return Ingredient.of(new ItemStack(TFCTextileItems.DIREWOLF_FUR.get(), 1));
    }

    @Override
    public @NotNull String getName() {
        return "tfc_textile:direwolf_fur";
    }
    ...
    public TempModifier getTempModifier(ItemStack stack) {
        return new TempModifier(ForgeRegistries.ITEMS.getKey(stack.getItem()).toString(), 5f, -0.15f);
    }
}
