...
public class PolarClothesMaterial implements ArmorMaterial, TemperatureAlteringMaterial {

    public static final PolarClothesMaterial MATERIAL = new PolarClothesMaterial();
    ...
    public @NotNull Ingredient getRepairIngredient() {
        return Ingredient.of(new ItemStack(TFCTextileItems.POLARBEAR_FUR.get(), 1));
    }

    @Override
    public @NotNull String getName() {
        return "tfc_textile:polarbear_fur";
    }
