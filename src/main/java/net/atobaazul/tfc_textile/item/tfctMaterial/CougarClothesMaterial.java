...
public class CougarClothesMaterial implements ArmorMaterial, TemperatureAlteringMaterial {
    ...
    public @NotNull Ingredient getRepairIngredient() {
        return Ingredient.of(new ItemStack(TFCTextileItems.COUGAR_FUR.get(), 1));
    }

    @Override
    public @NotNull String getName() {
        return "tfc_textile:cougar_fur";
    }
