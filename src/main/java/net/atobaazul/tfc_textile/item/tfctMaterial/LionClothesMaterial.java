...
public class LionClothesMaterial implements ArmorMaterial, TemperatureAlteringMaterial {
    ...
    public @NotNull Ingredient getRepairIngredient() {
        return Ingredient.of(new ItemStack(TFCTextileItems.LION_FUR.get(), 1));
    }

    @Override
    public @NotNull String getName() {
        return "tfc_textile:lion_fur";
    }
    ...
    public TempModifier getTempModifier(ItemStack stack) {
        return new TempModifier(ForgeRegistries.ITEMS.getKey(stack.getItem()).toString(), 3f, -0.20f, 0.15f);
    }
}
