...
public class TigerClothesMaterial implements ArmorMaterial, TemperatureAlteringMaterial {
    ...
    public @NotNull Ingredient getRepairIngredient() {
        return Ingredient.of(new ItemStack(TFCTextileItems.TIGER_FUR.get(), 1));
    }

    @Override
    public @NotNull String getName() {
        return "tfc_textile:tiger_fur";
    }
