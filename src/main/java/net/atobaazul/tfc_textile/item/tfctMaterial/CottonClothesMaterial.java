...
public class CottonClothesMaterial implements ArmorMaterial, TemperatureAlteringMaterial {
    ...
    public @NotNull Ingredient getRepairIngredient() {
        return Ingredient.of(new ItemStack(TFCTextileItems.COTTON_CLOTH.get(), 1));
    }

    @Override
    public @NotNull String getName() {
        return "tfc_textile:cotton_cloth";
    }
