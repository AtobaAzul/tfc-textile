...
public class CrocodileLeatherClothesMaterial implements ArmorMaterial, TemperatureAlteringMaterial{
    ...
    public @NotNull String getName() {
        return "tfc_textile:crocodile_leather";
    }
    ...
    public TempModifier getTempModifier(ItemStack stack) {
        return new TempModifier(ForgeRegistries.ITEMS.getKey(stack.getItem()).toString(), -0.5f, -0.25f, -0.25f);
    }
