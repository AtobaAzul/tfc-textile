...
public class DyeableWhiteClothingItem extends DyeableArmorItem {
    public DyeableWhiteClothingItem(ArmorMaterial p_266710_, Type p_267178_, Properties p_267093_) {
