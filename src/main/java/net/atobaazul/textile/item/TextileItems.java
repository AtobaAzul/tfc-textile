...
import net.atobaazul.textile.item.material.*;
...
public class TextileItems {
    public static final DeferredRegister<Item> ITEMS =
            DeferredRegister.create(ForgeRegistries.ITEMS, Textile.MOD_ID);


    public static final Map<TextileCrop, RegistryObject<Item>> CROP_SEEDS = TextileHelpers.mapOfKeys(TextileCrop.class, crop ->
            register("seeds/" + crop.name(), () -> new ItemNameBlockItem(TextileBlocks.CROPS.get(crop).get(), new Item.Properties()))
    );
    ...
    public static final RegistryObject<Item> COTTON_BALL = ITEMS.register(
            "cotton_ball",
            () -> new Item(new Item.Properties().stacksTo(32))
    ...
    public static final RegistryObject<Item> FLAX_FIBER = ITEMS.register(
            "flax_fiber",
            () -> new Item(new Item.Properties().stacksTo(32))
    );

    public static final RegistryObject<Item> FLAX = ITEMS.register(
            "flax",
            () -> new Item(new Item.Properties().stacksTo(32))
    );
    ...
    public static final RegistryObject<Item> RAW_BOOTS = ITEMS.register(
            "raw_boots",
    ...
    public static final RegistryObject<Item> CARIBOU_BOOTS = ITEMS.register(
            "caribou_boots",
    ...
    public static final RegistryObject<Item> COUGAR_BOOTS = ITEMS.register(
            "cougar_boots",
    ...
    public static final RegistryObject<Item> PANTHER_BOOTS = ITEMS.register(
            "panther_boots",
    ...
    public static final RegistryObject<Item> SABERTOOTH_BOOTS = ITEMS.register(
            "sabertooth_boots",
    ...
    public static final RegistryObject<Item> BLACK_BEAR_BOOTS = ITEMS.register(
            "black_bear_boots",
    ...
    public static final RegistryObject<Item> GRIZZLY_BEAR_BOOTS = ITEMS.register(
            "grizzly_bear_boots",
    ...
    public static final RegistryObject<Item> DIREWOLF_BOOTS = ITEMS.register(
            "direwolf_boots",
    ...
    public static final RegistryObject<Item> LION_BOOTS = ITEMS.register(
            "lion_boots",
